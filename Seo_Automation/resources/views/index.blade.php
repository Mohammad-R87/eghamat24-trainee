    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 d-flex flex-column justify-content-center text-right">
                ...
                <h5 class="aos-init aos-animate">ابزار تحقیق کلمات کلیدی، بررسی سئو رقبا، رهگیری رتبه کلمات کلیدی، بررسی
                    خطاهای سایت</h5>
            ...
            <div class="col-lg-5 hero-img aos-init aos-animate"><img src="../images/features-2.png" class="img-fluid"
                                                                     alt=""/></div>
        </div>
    </div>
</section>
